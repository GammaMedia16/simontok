            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body ">
                  <form id="createOtherForm" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    <div class="alert" style="display: none;"></div>
                      ...
                      <div class="col-lg-8">
                          <input type="text" class="form-control" name="detail_1" id="detail_1" value=""/>
