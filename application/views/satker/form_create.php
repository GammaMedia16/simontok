            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body ">
                  <form id="createSatkerForm" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    <div class="alert" style="display: none;"></div>
                      ...
                      <div class="col-lg-8">
                          <input type="text" class="form-control" name="nama_satker" id="nama_satker" value=""/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-3 control-label">Kode Satuan Kerja</label>
                      <div class="col-lg-6">
                          <input type="text" class="form-control" name="kode_satker" id="kode_satker" value=""/>
                      </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Alamat</label>
                        <div class="col-lg-8">
                            <textarea id="alamat" class="form-control" name="alamat" cols="50"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-6">
                          <input type="text" class="form-control" name="telp" id="telp" value=""/>
                      </div>
                    </div>
                    <div class="form-group">
