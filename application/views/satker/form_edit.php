                ...
                <div class="panel-body ">
                  <form id="updateSatkerForm" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    <div class="alert" style="display: none;"></div>
                      ...
                      <div class="col-lg-8">
                          <input type="text" class="form-control" name="nama_satker" id="nama_satker" value="<?= $record->nama_satker ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-6">
                          <input type="text" class="form-control" name="kode_satker" id="kode_satker" value="<?= $record->kode_satker ?>" readonly/>
                      </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Alamat</label>
                        <div class="col-lg-8">
                            <textarea id="alamat" class="form-control" name="alamat" cols="50"><?= $record->alamat ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-3 control-label">Email</label>
                      <div class="col-lg-6">
                          <input type="text" class="form-control" name="email" id="email" value="<?= $record->email ?>"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-3 control-label">No Telepon</label>
                      <div class="col-lg-6">
                          <input type="text" class="form-control" name="telp" id="telp" value="<?= $record->telp ?>"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-3 control-label">Kawasan Konservasi</label>
                      <div class="col-lg-8 inputGroupContainer">
                          <select name="reg_kk[]" id="reg_kk" class="form-control select2" style="width: 100%;" multiple="multiple" data-placeholder="-- Pilih Kawasan Konservasi --">
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-offset-3">
                            ...
                            <a href="<?= base_url('referensi/satker') ?>" class="btn btn-primary">Batal</a>
                        </div>
                    </div>
                    <div class="alert" style="display: none;"></div>
                  </form>
