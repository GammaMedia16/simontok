            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body ">
                  <form id="detailAdmDaerahForm" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-8">
                          ...
                          <input type="text" readonly="" class="form-control" name="nama_desa" id="nama_desa" value="<?= $row_data->nama_desa ?>"/>
                      </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 inputGroupContainer">
                            <div class="input-group input-append">
                                <input type="text" readonly="" class="form-control" id="lat" name="lat" value="<?= $row_data->lat ?>" />
                                <span class="input-group-addon add-on">LAT</span>
                            </div>
                        </div>
                        <div class="col-lg-4 inputGroupContainer">
                            <div class="input-group input-append">
                                <input type="text" readonly="" id="lon" name="lon" value="<?= $row_data->lon ?>" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea id="sejarah" readonly="" class="form-control" name="sejarah" cols="50"><?= $row_data->sejarah ?></textarea>
                        </div>
                    </div>  
                    <div class="form-group">
                        <label class="col-lg-8 pull-left col-lg-offset-3">Diperbarui oleh <?= $row_data->nama_user ?> pada <?php $waktu = date_create($row_data->last_update); echo date_format($waktu, 'd M Y H:i:s'); ?></label>
                    </div>  
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-offset-3">
                            <a href="<?= base_url('referensi/administrasi/data/'.$row_data->id_prov.'/'.$row_data->id_kab_kota.'/'.$row_data->id_kec) ?>" class="btn btn-primary">Kembali</a>
                        </div>
                    </div>
                    <div class="alert" style="display: none;"></div>
                </form>
