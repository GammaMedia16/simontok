            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body ">
                  <form id="editAdmDaerahForm" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    <div class="alert" style="display: none;"></div>
                    <input type="hidden" class="form-control" readonly="" name="kategori" id="kategori" value="<?= $kategori ?>"/>
                    <?php if ($kategori == 'prov' && $id != NULL) { ?>
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="nama_prov" id="nama_prov" value="<?= $row_data->nama_prov ?>"/>
                        </div>
                      </div>
                    <?php } else if ($kategori == 'kabkota' && $id != NULL) { ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="nama_kab_kota" id="nama_kab_kota" value="<?= $row_data->nama_kab_kota ?>"/>
                        </div>
                      </div>
                    <?php } else if ($kategori == 'kec' && $id != NULL) { ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="nama_kec" id="nama_kec" value="<?= $row_data->nama_kec ?>"/>
                        </div>
                      </div>
                    <?php } else if ($kategori == 'desa' && $id != NULL) { ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="hidden" class="form-control" readonly="" name="id_desa" id="id_desa" value="<?= $row_data->id_desa ?>"/>
                            <input type="text" class="form-control" name="nama_desa" id="nama_desa" value="<?= $row_data->nama_desa ?>"/>
                        </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-lg-4 inputGroupContainer">
                              <div class="input-group input-append">
                                  <input type="text" class="form-control" id="lat" name="lat" value="<?= $row_data->lat ?>" />
                                  <span class="input-group-addon add-on">LAT</span>
                              </div>
                          </div>
                          <div class="col-lg-4 inputGroupContainer">
                              <div class="input-group input-append">
                                  <input type="text" id="lon" name="lon" value="<?= $row_data->lon ?>" class="form-control">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-lg-8">
                              <textarea id="sejarah" class="form-control" name="sejarah" cols="50"><?= $row_data->sejarah ?></textarea>
                          </div>
                      </div>
                    <?php } ?>
