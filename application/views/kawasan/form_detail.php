                  ...
                  <form id="" action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
                    <div class="alert" style="display: none;"></div>
                      ...
                      <div class="col-lg-8">
                          ...
                          <input type="text" readonly="" class="form-control" name="nama_kk" id="nama_kk" value="<?= $record->nama_kk ?>"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-3 control-label">Register Kawasan</label>
                      <div class="col-lg-6">
                          <input type="text" readonly="" class="form-control" name="reg_kk" id="reg_kk" value="<?= $record->reg_kk ?>"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-3 control-label">ID WDPA</label>
                      <div class="col-lg-6">
                          <input type="text" readonly="" class="form-control" name="wdpa_id" id="wdpa_id" value="<?= $record->wdpa_id ?>"/>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4 inputGroupContainer">
                          <select disabled="" name="fungsi_kk_id" id="fungsi_kk_id" class="form-control" style="width: 100%;" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <div class="input-group input-append">
                              <input readonly="" type="text" class="form-control" id="luas_kk" value="<?= $record->luas_kk ?>" name="luas_kk" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <div class="input-group input-append">
                              <input readonly="" type="text" class="form-control" value="<?= $record->luas_zona ?>" id="luas_zona" name="luas_zona" />
                              <span class="input-group-addon add-on">Ha</span>
                          </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <div class="input-group input-append">
                              <input readonly="" type="text" class="form-control" value="<?= $record->luas_open_area ?>" id="luas_open_area" name="luas_open_area" />
                              <span class="input-group-addon add-on">Ha</span>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-offset-3">
                            <a href="<?= base_url('referensi/kawasan') ?>" class="btn btn-primary">Kembali</a>
                        </div>
                    </div>
