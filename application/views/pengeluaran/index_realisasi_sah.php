    ...
    <div class="col-lg-12">
        <div class="panel">
                <div class="panel-header">
                  <h3 class="panel-heading">Data Realisasi Pengesahan Pagu Anggaran Tahun <?= $tahun_exist ?> <?= $filter_tgl_exist ?></h3>
                  <div class="col-lg-12">
                    <form method="post" role="form" class="form-horizontal">
                        <div class="form-group">
                          ...
                          <div class="col-lg-3">
                            ...
                            <a href="<?php base_url('pengeluaran/pengesahan') ?>" class="btn btn-success">Reset</a>
                          </div>
                        </div>
                    </form>
                            ...
                            <?php $no=1; foreach ($record as $row) { 
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="<?=base_url();?>pengeluaran/addrealisasisah/<?= $row->kdindex ?>"><?= $keterangan ?></a>
                                    
                                </td>
                                <td align="right"><?= number_format($row->pagu, 0, ',', '.'); ?></td>
                                <td align="right"><?= number_format($row->jml_realisasi_sah, 0, ',', '.'); ?></td>
                                <td align="right"><?= number_format($row->sisa_sah, 0, ',', '.'); ?></td>
                                <td align="right">
                                  <?php
                                    $target = $row->pagu;
                                    $real = $row->jml_realisasi_sah;
