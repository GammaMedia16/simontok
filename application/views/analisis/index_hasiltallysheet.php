...
<div class="col-lg-12">
	<span style="font-size:16pt;font-weight:300;"><?= strtoupper($title)." : ".strtoupper($judul)."<br>".$periode ?></span>
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-header">
              <h3 class="panel-heading"><?= "Data ".ucwords($judul) ?></h3>
...
<div class="row">
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-header">
              <h3 class="panel-heading"><?= "Data ".ucwords($judul)." per Resort - Tahun ".date('Y') ?></h3>
                  
            </div><!-- /.panel-header -->
            <div class="panel-body">
                <div class="chart-responsive">
                    <div>
                        <canvas id="barChartperResort" style="width:100%"></canvas>
                    </div>
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-header">
              <h3 class="panel-heading"><div id="addJudul<?= $i ?>"></div></h3>
...
<script src="<?=base_url('assets/dist/js/content/hasil-tallysheet.js')?>"></script>
<?php
