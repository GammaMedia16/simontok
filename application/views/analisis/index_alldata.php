...
<div class="col-lg-12">
  <span style="font-size:16pt;font-weight:300;"><?= strtoupper($title).' TAMAN NASIONAL TAKA BONERATE' ?></span>
...
<!-- Main row -->
      ...
      <div class="col-md-12">
        <div class="panel">
          <div class="panel-header with-border">
            <h3 class="panel-heading">Rekap Monitoring Data Taman Nasional Kepulauan Seribu</h3>
          </div><!-- /.panel-header -->
  ...
  <?php $i = 1; foreach ($rTallysheet as $rTallysheet) {  
    ...
    ?>
    <div class="col-lg-12">
        <div class="panel panelDynamic">
            <div class="panel-header">
              <h3 class="panel-heading"><?= "Data ".ucwords($rTallysheet->name)." Tahun ".date('Y') ?></h3>
            ...
            <div class="panel-body">
              ...
              <?php if (($c % 2) == 0 || count($arrColReff) == 1      ) {
              ...
              <div class="col-lg-12">
                <div class="chart-responsive">
                  <p class="text-center">
                  <strong>
                    Rekap Data per Kawasan
                  </strong></p>
                  <div>
                      <canvas id="barChartAllResort<?= $rTallysheet->tallysheet_id ?>" style="width:100%"></canvas>
                  </div>
                </div>
              </div>
            </div><!-- /.panel-body -->
...
<script src="<?=base_url('assets/dist/js/content/hasil-alldata.js')?>"></script>
<?php
