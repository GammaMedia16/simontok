...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyA5atty-yKND9RzcKGhNFtmDiX-39C9QTE'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "-3, 118";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $scaleControlPosition		= 'BOTTOM_RIGHT';						// The position of the Scale control, eg. 'BOTTOM_RIGHT'
