...
//require_once APPPATH."third_party/Ciqrcode.php";//Your problem was here
...
class CI_Ciqrcode {
	...
	function __construct($config = array()) {
		...
		require_once APPPATH."third_party/qrcode/qrconst.php";
		require_once APPPATH."third_party/qrcode/qrtools.php";
		require_once APPPATH."third_party/qrcode/qrspec.php";
		require_once APPPATH."third_party/qrcode/qrimage.php";
		require_once APPPATH."third_party/qrcode/qrinput.php";
		require_once APPPATH."third_party/qrcode/qrbitstream.php";
		require_once APPPATH."third_party/qrcode/qrsplit.php";
		require_once APPPATH."third_party/qrcode/qrrscode.php";
		require_once APPPATH."third_party/qrcode/qrmask.php";
		require_once APPPATH."third_party/qrcode/qrencode.php";
